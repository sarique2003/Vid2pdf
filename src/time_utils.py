def convert_clock_time_to_timestamp_ms(clock_time):
    """Converts time from HH:MM:SS format to timestamp format (in milliseconds)  For instance, given "00:05:38", it will return 338000
    """
...
def convert_timestamp_ms_to_clock_time(timestamp_ms):
    """Converts time in milliseconds to clock time For instance, given 338000, it will return "00:05:38"  """
